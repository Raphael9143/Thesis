...
Class.belongsToMany(Course, { through: ClassCourse, foreignKey: 'class_id', otherKey: 'course_id', as: 'courses' });
Course.belongsToMany(Class, { through: ClassCourse, foreignKey: 'course_id', otherKey: 'class_id', as: 'classes' });
