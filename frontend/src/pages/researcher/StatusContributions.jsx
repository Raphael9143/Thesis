...
export default function StatusContributions({ status }) {
  ...
  useEffect(() => {
    ...
    const fetchContributions = async () => {
      setLoading(true);
      try {
        const res = await userAPI.getContributionsByStatus(projectId, status, currentPage);
