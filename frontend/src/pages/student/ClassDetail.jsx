                  ...
                  {lectures.map((l) => (
                    <li key={l.id} className="class-detail__list-item">
                      <div className="class-detail__list-row">
                        <div
                          className="class-detail__item-click"
                          onClick={() =>
                ...
                <ul className="class-detail__list">
                  {assignments.map((a) => (
                    <li
                      ...
                      onClick={() =>
                        navigate(
                          `/education/student/classes/${id}/courses/${courseIdState}/assignments/${a.assignment_id}`
                        )
                      }
                    >
                ...
                <ul className="class-detail__list">
                  {exams.map((ex) => (
                    <li
                      ...
                      className="class-detail__list-item"
                      onClick={() =>
                        navigate(`/education/student/classes/${id}/courses/${courseIdState}/exams/${ex.id}`)
                      }
                    >
